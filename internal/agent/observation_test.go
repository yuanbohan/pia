...
func TestRunEmitsErrorSettlementsWithoutCopyingProviderError(t *testing.T) {
	...
	if _, err := runtime.Run(context.Background(), nil, []string{"fail"}, emptySteeringSource{}); err == nil {
...
func TestSerialToolErrorSettlesOnlyThatToolAsError(t *testing.T) {
	...
	if _, err := runtime.Run(context.Background(), nil, []string{"inspect then update"}, emptySteeringSource{}); err != nil {
